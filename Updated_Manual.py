...
class TransactionProcessor:
    def __init__(self,wallet_address):
        ...
        self.async_solana_client = AsyncClient("https://mainnet.helius-rpc.com/?api-key=24ba856d-adad-4070-a177-c06e461f7ad6")
    ...
    #     # solana_client = Client("https://mainnet.helius-rpc.com/?api-key=463c5e26-e304-4db4-afc3-16d6c10fe29e")
    #     try:
    #         print("Fetching Token Accounts for:", self.wallet_address)
    ...
    #         # Get the wallet address ID from the database
    #         wallet_address_id = self.wallet_address_id
    #
    ...
    #         # print(len(newTokenAccounts),print(newTokenAccounts))
    #         if len(newTokenAccounts)==0:
    #             print("No new token Accounts")
    #             return
    #         else:
    #             print(f"Fetching this Number of token Accounts:  {len(newTokenAccounts)}")
    #
    #
    #
    #         new_token_accounts = list(newTokenAccounts)
    #         # print(new_token_accounts)
    #
    #
    #         for token_account in newTokenAccounts:
    #             print("Getting Token Account",token_account)
    #             sig= await self.async_solana_client.get_signatures_for_address(Pubkey.from_string(token_account), limit=50)
    ...
    #
    #             await self.update_token_account(wallet_address, Pubkey.from_string(token_account), block_time,wallet_address_id)
    ...
    #     except Exception as e:
    #
    #         print("Error Updating Continuing Fetching",e)
    #         pass
    ...
    def print_summary(self):
        ...
        #     print(f"Last Trade: {datetime.fromtimestamp(self.last_trade).strftime('%Y-%m-%d %H:%M:%S')}")
        # else:
        ...
        # print("first buy time",self.convert_unix_to_date(self.first_buy_time))
        # print("firstBuy Unix",self.first_buy_time)
        # print("Buy Period:", self.buy_period)

        # print("Token Creation", round(self.tokenCreationTime))

        # print("PairTime", await self.pair_createdTime(self.wallet_address))
        ...
        if self.tokenCreationTime == 0:
            ...
            # print("Token Creation", self.convert_unix_to_date(round(self.tokenCreationTime)))

            # print(self.first_buy_time,self.tokenCreationTime)
            try:
    ...
    async def calculate_deltas(self):
        ...
        if self.sells >0:
            ...
            # token_value_in_sol = await self.getToken_SolAmount()
            #
            # self.delta_token = 0
            # self.delta_sol = token_value_in_sol - self.spent_sol
            # self.delta_percentage = (self.delta_sol / self.spent_sol) * 100
        ...
        # print("First Buy Time",self.first_buy_time)
    ...
    async def process_transactions(self):
        ...
        try:
            ...
            # if self.wallet_address_id is None:
            ...
            #     scanning = False
            #     print("ALL TOKEN ACCOUNT PROCESSED")
            # while True:
            #     await self.process_token_account(new_token_accounts, wallet_address_id)
            ...
            # if num_tokenAccounts in range(1, 5000):
            #     print(f"Processing Address {self.wallet_address}")
            #
            #
            #     # print(len(newTokenAccounts),print(newTokenAccounts))
            #     if len(newTokenAccounts) not in range(1,5000) :
            #         print(f"{style.RED}Skipping Wallet Address {self.wallet_address} with {num_tokenAccounts} token accounts ",style.RESET)
            #         return
            #     if len(newTokenAccounts) != 0 :
            #         print(f"Processing Address {self.wallet_address} Number of Token Accounts to be Processed {len(newTokenAccounts)}")
            #         new_token_accounts = list(newTokenAccounts)
            #         await self.process_token_account(new_token_accounts, wallet_address_id)
            #         print("ALL TOKEN ACCOUNT PROCESSED")
            #
...
async def run():
    # Initialize the TransactionProcessor with a specific wallet address
    #DCAK8tuwzsNowVA6eSojLHhHSDQMyECuSbu7KovyvYbm
    #618MjQ248FfbZcTiEaiRCBAfSTnNs3zzT1c43kwvQtZb
    #3YvpKCCotiqg4DJWsUFvXkh5enULm6q59Co2c2LwGVjR
    #8h7SCUPk8JPZyfbmCogrDfw4UVEr2g8q75QLdikEuKrm
    #4ApVF262nvLF4T6X24eQNBJiA5nQaRkdG24ZQW7RH8T2
    #336wYiTLyuF4RESNR5b7cCS64gXpDSGJcrGHorWNvWva
    #52oKsMVwkUD1vxNQBYqcSswagAniGha6B9ns5Ym1NRP6

    ##Bruteforce##
    #CaShxDq2Vbdp2XryjDdUZthbTzwYsvKuH6Knn9pPi4xU
    #ATomG2gRJcB2jNvwcjo2zBMoyLsHZzLgwqy651zzYoCq
    #DQeJQ91Uzcuyk4iAtpQ9FwD8Ddwr62NeWd8hoE1kgLLs
    #
    #2EVG2pDH44aweg5jMa7bnj7MW8w11ADLYQ7R3kLkKaV5

    ###4M5bpMDhNwqXong3LoaU1LG5WYu7rUWbCxuWHKRRY3Mf
    #HNRYmreN6HKrZeMSZuFTPP8N8Usp1jH4p7pgKUtZKzuu
    processor = TransactionProcessor(Pubkey.from_string("EWzk2847WCPis45hPQ6Em5UuRbZiP1CSmqx7nG9ELd2L"))
    #ZEH77BamKQZfxv9RPFzmAsWjM2ArjcxYYCy2BhQZuM2
    #4DdrfiDHpmx55i4SPssxVzS9ZaKLb8qr45NKY9Er9nNh
    #BNLY7b3hFR2NQ2iMuLxjYAmcMj3deDrrymJNsTiMrDFe
    #FJ34cZSobZawiMsAQ4ZSqZu8nVw2SBYQCJNJfgoztz25

    #2JMC8J5ypBULTpPQ9i7G4tbXrAEQGvRn7UJ4CNkJ6rLF

    #97Sbxrym2z4CLezbN5DVvxBsUin38ynXbWRcAqe4JyMh
    #oooEYsNtbAnQnkx6SMtVui9iwP4Eu3KuTGC6NAp2gk2

    #4SSogjcLCTdtutZJPS95X3HPu76LsewuU7CH9RvwJBCk

    #HZik5nT9ZiZLCR1b3GCDYs4aTuNry5AxV4m2ENemkfZK --toCheck
    #336wYiTLyuF4RESNR5b7cCS64gXpDSGJcrGHorWNvWva
    #CRUShXULZJfeWt8ej9aNJZBuLzbqUc9XWtBuKQyRVCw9
    #4ApVF262nvLF4T6X24eQNBJiA5nQaRkdG24ZQW7RH8T2
    #2EVG2pDH44aweg5jMa7bnj7MW8w11ADLYQ7R3kLkKaV5
...
#DTMDHQfaVTAh5sYPyQusEgHW9Rmz3VPfua7EZdU3vDHH
#oooEYsNtbAnQnkx6SMtVui9iwP4Eu3KuTGC6NAp2gk2

    # await asyncio.gather(
    #     processor.process_transactions(),
    #     # processor.generate_reports_for_time_periods([90,60,30,14,7]), #Uncomment and put time period
